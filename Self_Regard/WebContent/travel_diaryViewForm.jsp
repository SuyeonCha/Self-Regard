			...
			<tbody>
				<% //댓글!!!
					...
					for(int i = 0; i < list.size(); i++){
						...
						<tr>
							<td colspan=3 class="coment_md"><a onclick="location.href='travel_commUpdateForm.jsp?ID=<%=list.get(i).getID() %>'">수정</a>
							<td><a onclick="return confirm('정말로 삭제하시겠습니까?')" href='travel_commDelete.jsp?ID=<%=list.get(i).getID() %>'>삭제</a>
							</td>
						</tr>
				<%
					}
