		...
		<table class="coment_t2">
			<tbody>
				...
				<tr>
					...
					<a onclick="location.href='beauty_commUpdateForm.jsp?ID=<%=list.get(i).getID() %>'">수정</a>
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href='beauty_commDelete.jsp?ID=<%=list.get(i).getID() %>'>삭제</a>
					</td>
				</tr>
				<%
					}
