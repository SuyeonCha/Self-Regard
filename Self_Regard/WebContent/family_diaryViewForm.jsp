				...
				<% //댓글!!!
					...
					for(int i = 0; i < list.size(); i++){
						...
						<tr>
							...
							<a onclick="location.href='family_commUpdateForm.jsp?ID=<%=list.get(i).getID() %>'">수정</a>
							<a onclick="return confirm('정말로 삭제하시겠습니까?')" href='family_commDelete.jsp?ID=<%=list.get(i).getID() %>'>삭제</a>
							</td>
						</tr>
				<%
					}
